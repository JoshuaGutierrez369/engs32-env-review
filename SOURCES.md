...
| **UN SDGs** count & Goal 13 | [UN SDGs portal](https://sdgs.un.org/goals) | **17** goals; Goal 13 = Climate Action. |
| **Brundtland definition** | *Our Common Future* (1987) — commonly archived via UN / WCED summaries | Intergenerational phrasing matches standard citation. |
| **IPCC** (GHGs, feedbacks, lifetimes) | IPCC AR6 WGI / glossaries | Use for greenhouse effect, CH₄ vs CO₂ lifetimes, ice–albedo feedback context. |
| **HDI / GII / MPI** | [UNDP Human Development Reports](https://hdr.undp.org/) | Official methodology for composite indices. |
| **EPI** | [Yale EPI](https://epi.yale.edu/) | Composite environmental performance ranking. |

### Course slide vs statute

If a slide lists **RA 9003 “enacted February 16, 2001”**, treat that as a **typo**: the **Republic Act header on Lawphil** reads **26 January 2001**. Prefer the statute for exams.
